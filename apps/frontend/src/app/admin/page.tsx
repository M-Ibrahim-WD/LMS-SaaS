...
export default function AdminPage() {
  ...
  return (
    ...
    >
      ...
      {hasAdminPermission("MANAGE_PLANS") ? (
      ...
      {hasAdminPermission("REVIEW_TENANTS") ? (
      ...
      {(hasAdminPermission("REVIEW_STUDENTS") || hasAdminPermission("REVIEW_INSTRUCTORS")) ? (
      ...
      {(hasAdminPermission("REVIEW_COURSES") || hasAdminPermission("REVIEW_PAYMENTS")) ? (
      <div className="mt-8 grid gap-6 xl:grid-cols-2">
      ...
      {hasAdminPermission("VIEW_OVERVIEW") ? <ContentCard className="mt-8 p-6">
