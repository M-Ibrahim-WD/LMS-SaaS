export function SiteFooter() {
  return (
    <footer className="px-4 pb-5 pt-2 text-center text-sm text-slate-500 sm:px-6 sm:pb-6">
      <div className="mx-auto max-w-6xl rounded-full border border-slate-200/70 bg-white/70 px-4 py-3 shadow-[0_14px_40px_-28px_rgba(15,23,42,0.32)] backdrop-blur">
